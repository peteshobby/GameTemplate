...
void InitializeTileLayer(void) {
    // ULA Control
    ZXN_NEXTREGA(0x68, 0b10000000);

    // // Tile layer transparent
     ZXN_NEXTREGA(0x4C, GLOBAL_TRANSPARENT);

    // Enable tilemap mode
	ZXN_NEXTREGA(0x6B, 0b10000011);		//; 40x32, 8-bit entries
	ZXN_NEXTREGA(0x6C, 0b00100000);		//; palette offset, visuals

    // Tell harware where to find tiles
	ZXN_NEXTREGA(0x6E, OFFSET_OF_MAP); //	; MSB of tilemap in bank 5
	ZXN_NEXTREGA(0x6F, OFFSET_OF_TILES); //	; MSB of tilemap definitions
}
